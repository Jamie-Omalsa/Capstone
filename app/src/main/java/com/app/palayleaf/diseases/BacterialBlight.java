...
public class BacterialBlight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bacterial_blight);
        ...
        saveBtn = findViewById(R.id.saveBtn);  // Save Button
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        String savedImageURL = MediaStore.Images.Media.insertImage(
                contentResolver,
                bitmap,
                "Bacterial Blight Disease Image",
                "Image of a leaf detected with Bacterial Blight disease"
        );
