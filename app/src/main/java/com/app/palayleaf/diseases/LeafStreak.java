...
public class LeafStreak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leaf_streak);
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        String savedImageURL = MediaStore.Images.Media.insertImage(
                contentResolver,
                bitmap,
                "Leaf Streak Disease Image",
                "Image of a leaf detected with Leaf Streak disease"
        );
