...
public class LeafSmut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leaf_smut);
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        String savedImageURL = MediaStore.Images.Media.insertImage(
                contentResolver,
                bitmap,
                "LeafSmut Disease Image",
                "Image of a leaf detected with LeafSmut disease"
        );
