...
public class NarrowBrownSpot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_narrow_brown_spot);
        ...
        // Retrieve image byte array from intent and convert to Bitmap
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        String savedImageURL = MediaStore.Images.Media.insertImage(
                contentResolver,
                bitmap,
                "Narrow Brown Spot Disease Image",
                "Image of a leaf detected with Narrow Brown Spot disease"
        );
